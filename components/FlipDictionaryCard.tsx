...
export default function FlipDictionaryCard({
  ...
  imageUrl, audioUrl, wordType, category, wordId,
              ...
              {category === 'abeceda' ? (
                ...
                <div style={{ position: "relative", width: "100%", height: "100%" }}>
                  ...
                  <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(to top, rgba(0,0,0,0.72) 0%, transparent 100%)", padding: "28px 12px 10px", textAlign: "center" }}>
                    <span style={{ color: "white", fontWeight: 900, fontSize: 18, textShadow: "0 1px 4px rgba(0,0,0,0.4)", letterSpacing: 0.5 }}>{wordHr}</span>
                  </div>
                </div>
              ) : (
