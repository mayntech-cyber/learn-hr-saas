...
import { Home, BookOpen, HardHat, GraduationCap, User, Settings, MousePointer2, CreditCard } from "lucide-react";
...
export default function Navigation() {
  ...
  const tChangeLang = t("Promijeni jezike");
  ...
  const navItems = [
    ...
    { nameObj: tNavPricing, href: "/pricing",    icon: CreditCard },
