  ...
  return (
    <div className="p-4 md:p-10 max-w-6xl mx-auto min-h-screen animate-in fade-in duration-500">
      ...
      <div className="mb-8 md:mb-12">
        <Link href="/general" className="inline-flex items-center gap-2 text-slate-500 hover:text-purple-600 font-bold mb-6 transition-colors bg-white px-4 py-2 rounded-full shadow-sm border border-slate-200">
          <ArrowLeft size={18} /> {tBack.main}
        </Link>
        
        <div className="flex flex-col md:flex-row items-center gap-4">
          <div className="bg-purple-600 p-4 rounded-[1.5rem] text-white shadow-lg shadow-purple-200">
            <Puzzle size={32} />
          </div>
          <div className="text-center md:text-start">
            ...
            {!tTitle.isOnlyHr && (
              <p className="text-xs md:text-sm font-black text-purple-400 uppercase mt-1 tracking-widest italic opacity-80">
                {tTitle.sub}
              </p>
            )}
